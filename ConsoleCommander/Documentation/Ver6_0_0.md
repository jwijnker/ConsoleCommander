...
Updated this version to use dotnet6 (Out of support) for legacy purpose.

A hand full of cleaning up and simplifications has been applied.
> Sample commander using (dotnet) DI has been removed.
> Sample commander using Unity DI has been removed.
> Sample commander using Castle Windsor has been removed.
> Sample commander using FileSystem monitor has been removed.

> Logging in testproject using internal XUnitLogger and Factory.
> Sample project MinimalSetupDemo has been added.
...
A new version for dotnet8 will become avialable soon.
